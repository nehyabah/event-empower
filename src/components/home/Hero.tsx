...
const Hero = () => {
  ...
  return (
    <section className="relative pt-24 md:pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-wedding-navy/10 rounded-full blur-3xl animate-pulse-soft" style={{ animationDelay: "3s" }} />
      <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-wedding-burgundy/10 rounded-full blur-2xl animate-float" />
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-5 pt-4 animate-fade-in-up" style={{ animationDelay: "300ms" }}>
            <AuthModal 
              defaultTab="register" 
        ...
        <div className="w-full relative h-40 mt-6 pointer-events-none">
          ...
          <div className="absolute top-1/2 left-3/4 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full bg-wedding-sage/20 border border-wedding-sage/30 shadow-lg animate-float z-30" style={{ animationDelay: "3s" }}>
            <div className="absolute inset-0 flex items-center justify-center text-wedding-sage">
              <Gift className="w-8 h-8" />
            </div>
          </div>
          
          <div className="absolute top-3/4 left-1/3 transform -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-wedding-blush/20 border border-wedding-blush/30 shadow-lg animate-float z-30" style={{ animationDelay: "2.5s" }}>
            <div className="absolute inset-0 flex items-center justify-center text-wedding-blush">
              <Sparkles className="w-6 h-6" />
            </div>
          </div>
          
          <div className="absolute top-1/4 left-2/3 transform -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-wedding-navy/20 border border-wedding-navy/30 shadow-lg animate-float z-30" style={{ animationDelay: "4s" }}>
