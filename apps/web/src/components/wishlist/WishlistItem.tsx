...
import { Check, X, Gift, ExternalLink, Tag, UserX, ShoppingCart } from "lucide-react";
      ...
      <CardContent className="p-0">
        ...
        <div className="p-4 sm:p-5">
            ...
            <div className="space-y-1.5 flex-1 min-w-0">
              <h3
                className={`text-base font-medium truncate ${
                  item.purchasedBy ? "line-through text-muted-foreground" : ""
                }`}
              >
                {item.name}
              </h3>
          ...
          <div className="flex items-center justify-between gap-2">
            {/* Shop link — always visible when link exists */}
            {item.link ? (
              <a
                href={item.link}
                target="_blank"
