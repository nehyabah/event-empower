    ...
    <div className="min-h-screen bg-background">
      <div className="flex">
        ...
        <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
          <div className="flex flex-1 flex-col bg-wedding-navy border-r border-wedding-navy/80">
            {/* Logo */}
            <div className="flex h-16 items-center gap-2 px-6 border-b border-white/10">
              <Heart className="h-5 w-5 text-wedding-gold" />
              <div>
                <span className="font-serif text-sm font-bold text-white">Planr</span>
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-wedding-gold/15 text-white shadow-sm"
                        : "text-white/60 hover:bg-white/5 hover:text-white"
                    )}
                  >
                    <span className={cn(isActive ? "text-wedding-gold" : "text-white/40")}>
                      {item.icon}
                    </span>
                    {item.label}
                  </Link>
          ...
          <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b border-border bg-background/95 backdrop-blur-sm px-6">
            ...
            <div className="lg:hidden">
              <Link to="/admin" className="flex items-center gap-1.5">
                ...
                <span className="font-serif text-sm font-bold text-foreground">Planr</span>
